...
tabula_muris <- readRDS(here("tabula_muris/data/smartseq2_tabula_muris_annotated.rds"))

pData(tabula_muris)$tissue <- pData(tabula_muris)$sample
...
saveRDS(tabula_muris, here("tabula_muris/data/smartseq2_tabula_muris_annotated.rds"))
