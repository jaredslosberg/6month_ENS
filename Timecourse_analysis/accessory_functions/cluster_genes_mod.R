###JNS changed line 184 to do aggregation with raw transcripts rather than cell size normalized
#'
...
#' @export
aggregate_gene_expression_mod <- function(cds,
                                      gene_group_df = NULL,
                                      cell_group_df = NULL,
  ...
  #Here, JNS changed normalized_counts to exprs
  agg_mat <- exprs(cds)
  if(norm_method == "log_raw"){
    agg_mat <- log10(agg_mat + 1)
  }
