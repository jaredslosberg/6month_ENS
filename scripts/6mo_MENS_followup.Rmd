...
htmlwidgets::saveWidget(dt, file = "../results/MENS/MENS_subset_cluster_markers.html")
...
MENS_sub <- align_cds(MENS_sub, num_dim = 5, alignment_group = "batch + log10genes",alignment_k = 20,verbose=T)
MENS_sub <- reduce_dimension(MENS_sub,max_components=2,cores=4,verbose=TRUE)
...
```{r}
saveRDS(MENS, file = here(glue("6mo_MENS_{date}.rds")))
sessionInfo()
```
