...
if(do.existing.embedding){
  pdat <- read.csv(here("results/lmmp_umap_clusters_og.csv"), row.names = 1)
...
assertthat::assert_that(length(unique(pData(cds)$clusters)) == 15)
...
```{r}
if(!file.exists(here("results/lmmp_umap_clusters_og.csv"))){
